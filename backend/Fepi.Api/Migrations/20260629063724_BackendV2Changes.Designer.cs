...
namespace Fepi.Api.Migrations
{
    ...
    [Migration("20260629063724_BackendV2Changes")]
    partial class BackendV2Changes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Fepi.Api.Models.Contrato", b =>
                {
                    ...
                    b.Property<int?>("FinancialUsuarioId")
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("ResidenteUsuarioId")
                        .HasColumnType("integer");
                    ...
                    b.Property<int?>("SupervisorExternoUsuarioId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("FinancialUsuarioId");

                    b.HasIndex("NumeroContrato")
                        .IsUnique();

                    b.HasIndex("ResidenteUsuarioId");

                    b.HasIndex("SuperintendenteUsuarioId");

                    b.HasIndex("SupervisorExternoUsuarioId");
            ...
            modelBuilder.Entity("Fepi.Api.Models.ConvenioHistorial", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Fepi.Api.Models.Contrato", b =>
                {
                    ...
                    b.HasOne("Fepi.Api.Models.Usuario", "FinancialUsuario")
                        .WithMany()
                        .HasForeignKey("FinancialUsuarioId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Fepi.Api.Models.Usuario", "ResidenteUsuario")
                        .WithMany()
                        .HasForeignKey("ResidenteUsuarioId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                    ...
                    b.HasOne("Fepi.Api.Models.Usuario", "SupervisorExternoUsuario")
                        .WithMany()
                        .HasForeignKey("SupervisorExternoUsuarioId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.Navigation("Empresa");

                    b.Navigation("FinancialUsuario");

                    b.Navigation("ResidenteUsuario");

                    b.Navigation("SuperintendenteUsuario");

                    b.Navigation("SupervisorExternoUsuario");
                });
