...
import { mockContrato } from "../mock/mockContrato";
import { mockCurvaS } from "../mock/mockCurvaS";
        ...
        <Card style={{ padding: "16px 20px", marginBottom: 20 }}>
          ...
          >
            ...
            <span style={{ fontFamily: "JetBrains Mono", color: obra, fontWeight: 600 }}>
              {Math.round((ejercido / totalContratado) * 100)}%
            </span>
          </div>
          <div
            style={{ background: rule, borderRadius: 2, height: 8, overflow: "hidden" }}
          >
            <div
              style={{
                background: obra,
                height: "100%",
                width: `${(ejercido / totalContratado) * 100}%`,
                borderRadius: 2,
              }}
            />
          </div>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14 }}>
          <Card style={{ padding: "14px 16px" }}>
            ...
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
              ...
              <div style={{ fontSize: 12, color: muted, textAlign: "right" }}>
                <div>
                  Pagadas: <strong style={{ color: aprobado }}>3</strong>
                </div>
                <div>
                  Aprobadas: <strong style={{ color: obra }}>1</strong>
                </div>
              </div>
            </div>
          </Card>
          <Card style={{ padding: "14px 16px" }}>
            ...
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
              ...
              <div style={{ fontSize: 12, color: muted, textAlign: "right" }}>
                <div>
                  Aprobados: <strong style={{ color: aprobado }}>2</strong>
                </div>
                <div>
                  Variación: <strong style={{ color: observado }}>18%</strong>
                </div>
              </div>
            </div>
          </Card>
